...
// core components
import { downloadStyle } from '../../assets/jss/nextjs-material-kit/pages/componentsSections/downloadStyle';
...
const SectionDownload: React.FC<Props> = ({}: Props): React.ReactElement => {
